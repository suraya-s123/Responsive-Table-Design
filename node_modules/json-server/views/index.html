...
<body>
    ...
    <script>
        let isEditing = false; // Track if we are editing an existing employee
        let editingEmployeeID = null; // Track the ID of the employee being edited
        ...
        function addEmployee() {
            ...
            const empBloodGroup = document.getElementById('empBloodGroup').value;
            const empEducation = document.getElementById('empEducation').value;
        ...
        function populateTable(employees) {
            ...
            employees.forEach((employee, index) => {
                ...
                <td style="width:132px;" data-label="Action">
